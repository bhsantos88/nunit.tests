...
{
    // Create custom test constraints will help to avoid repetitions when you have the same behaviors and different values.
    class MonthlyRepaymentGreaterThanZeroConstraints : Constraint
    {
        public string ExpectedProductName { get; }
        public decimal ExpectedInterestRate { get; }

        public MonthlyRepaymentGreaterThanZeroConstraints(string expectedProductName,
